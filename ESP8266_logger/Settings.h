...
#define BOARD_NAME                    "Metabolizer"        // Name of your product. Should match App Export request info.
#define BOARD_VENDOR                  "Company Name"        // Name of your company. Should match App Export request info.

#define PRODUCT_WIFI_SSID             "Metabolizer"         // Name of the device, to be displayed during configuration. Should match export request info.
#define BOARD_CONFIG_AP_URL           "Metabolizer.cc"      // Config page will be available in a browser at 'http://our-product.cc/'
